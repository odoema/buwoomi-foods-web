...
function views() {
  ...
  return `<button class="cat-icon-btn ${state.cat === c ? "on" : ""}" data-cat="${c}" aria-label="Browse ${esc(c)}"><span class="circle-ic food-category-photo" style="background-image:url('https://raw.githubusercontent.com/odoema/buwoomi-foods-web/main/assets/category-icons.webp') !important;background-position:${spritePos} !important;background-size:500% 200% !important;background-repeat:no-repeat !important"></span><span>${c}</span></button>`;
}).join("")}</div></div>
