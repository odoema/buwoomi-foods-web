/* BUWOOMI desktop layout fix — laptop/desktop dense onboarding, not sparse empty gap */
(function () {
  if (document.getElementById('bw-desktop-css')) return;
  var s = document.createElement('style');
  s.id = 'bw-desktop-css';
  s.textContent = [
    /* Laptop / desktop: grow onboarding hero so white void is filled */
